//
//  ChoichesEnglishView.swift
//  Hibo
//
//  Created by Ana Caroline Sampaio Nogueira on 20/10/22.
//

import UIKit

class ChoichesEnglishView: UIView {
    ...
    let collectionView: UICollectionView = {
        ...
        cv.register(CustomCellLevel.self, forCellWithReuseIdentifier: "cell")
        return cv
    }()
    ...
    var pickerSemana: UIPickerView = {
        ...
        // pegar dia atual da semana e setar no picker
        return picker
    }()
    ...
    let buttonMatch: UIButton = {
        ...
        button.backgroundColor = UIColor(red: 49/255.0, green: 51/255.0, blue: 129/255.0, alpha: 1.0)
    ...
    private func configConstraints() {
        NSLayoutConstraint.activate([
            ...
            self.pickerSemana.topAnchor.constraint(equalTo: self.diaDaSemanaLabel.bottomAnchor),
            ...
            self.pickerSemana.heightAnchor.constraint(equalToConstant: 70),
            ...
            self.pickerHorario.topAnchor.constraint(equalTo: self.horarioLabel.bottomAnchor, constant: 20),
